...
var _userDetail = __webpack_require__(26);

var _userDetail2 = _interopRequireDefault(_userDetail);

var _bookingList = __webpack_require__(27);

var _bookingList2 = _interopRequireDefault(_bookingList);

var _ticketStorage = __webpack_require__(28);

var _ticketStorage2 = _interopRequireDefault(_ticketStorage);

var _booking = __webpack_require__(8);

var _booking2 = _interopRequireDefault(_booking);

var _extended_array = __webpack_require__(7);

var _extended_array2 = _interopRequireDefault(_extended_array);
...
class Popup extends _react2.default.Component {
  ...
  constructor(props) {
    ...
    this.handlerClearState = () => {
      ...
      this.setState({ UserInfo: new _userDetail2.default("", "") });
    };
    ...
    this.handlerPasswordChange = event => {
      let { UserInfo: userInfo } = this.state;
    ...
    this.handleLoginAdd = (() => {
      var _ref = _asyncToGenerator(function* (username, password) {
        let booking = new _booking2.default(0, new _userDetail2.default(username, password));
        try {
          console.log("calling save booking");
          let result = yield _this.ticketStorage.saveBooking(booking);
    ...
    this.deleteBookingById = bookingId => {
    ...
    this.ticketStorage = new _ticketStorage2.default();
    // Get the active tab and store it in component state.

    this.state = {
      UserInfo: new _userDetail2.default("", ""),
      Booking_List: null
    };
  }
  ...
  render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(_bookingList2.default, { bookings: Booking_List, deleteHandler: this.deleteBookingById }),
      _react2.default.createElement(
        'label',
        null,
        'User Name'
      ),
      _react2.default.createElement('input', { type: 'text', value: UserInfo.username, onChange: this.handlerUsernameChange }),
      _react2.default.createElement(
        'label',
        null,
        'Password'
      ),
      _react2.default.createElement('input', { type: 'password', value: UserInfo.password, onChange: this.handlerPasswordChange }),
      _react2.default.createElement(
        'button',
        { onClick: () => this.handleLoginAdd(UserInfo.username, UserInfo.password) },
        'Add'
      ),
      _react2.default.createElement(
        'button',
        { onClick: () => this.handlerClearState() },
        'Clear'
      ),
      _react2.default.createElement(
        'span',
...
class BookingList extends _react.Component {
    constructor(props) {
        super(props);

        this.getBookingList = (bookings, deleteHandler) => {
                ...
                return bookings.map(bk => {
                    ...
                    return _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'span',
                            null,
                            bk.UserDetail.username
                        ),
                        _react2.default.createElement(
                            'button',
                            { onClick: () => deleteHandler(bk.Id) },
                            'x'
                        )
                    );
                });
...
var _bookings = __webpack_require__(29);
...
class TicketStorage {
    ...
    getBookingById(bookingId) {
        return _asyncToGenerator(function* () {
            try {
                let bookingResult = yield browser.storage.sync.get(TicketStorage.Key);
                let testKey = Object.keys(bookingResult);
                if (testKey.length > 1) {
                    let retBooking = bookingResult.list.find(function (bk) {
                        return bk.Id == bookingId;
                    });
                    return retBooking;
                } else {
                    return null;
    ...
    getBookings() {
        return _asyncToGenerator(function* () {
            try {
                ...
                let testKey = Object.keys(bookingResult);
                if (testKey.length >= 1) {
                    let bookings = new _bookings2.default();
                    bookingResult[TicketStorage.Key].extArray.forEach(function (element) {
        ...
        return _asyncToGenerator(function* () {
            try {
                ...
                if (bookingKeys.length < 1 || bookingResult.extArray) {
                    ...
                    try {
                        let saveBooking = yield browser.storage.sync.set({ [TicketStorage.Key]: bookings });
                    ...
                    if (bookingResult.TicketStorage.extArray !== undefined && bookingResult.TicketStorage.extArray.length === 0) {
                        booking.Id = 1;
                        bookings.add(booking);
                    } else {
    ...
    deleteBookingById(bookingId) {
        return _asyncToGenerator(function* () {
            try {
                ...
                let testKey = Object.keys(bookingResult);
                if (testKey.length >= 1) {
                    let deleteObj = bookingResult[TicketStorage.Key].extArray.find(function (e) {
                        return e.Id === bookingId;
                    });
                    if (deleteObj) {
                        let bookings = new _bookings2.default();
                        bookingResult[TicketStorage.Key].extArray.forEach(function (element) {
                            if (element.Id !== bookingId) bookings.add(element);
                        });
                        let saveBooking = yield browser.storage.sync.set({ [TicketStorage.Key]: bookings });
                        return true;
                    } else {
...
TicketStorage.Key = "TicketStorage";
...
class Bookings {
    constructor() {
        // if(this.extArray)
        this.extArray = new _extended_array2.default();
    }

    add(booking) {
        if (booking) this.extArray.add(booking);
    }
